...
# ⬇️ Install VLab4Mic Locally

Choose your operating system and follow the instructions below to install VLab4Mic on your computer.
...
## 1. Click the button to download VLab4Mic executable

<a href="https://github.com/HenriquesLab/LabConstrictor-VLab4Mic/releases/download/0.1.3/VLab4Mic-0.1.3-Windows-x86_64.exe">
...
After installation, you can launch VLab4Mic from your desktop app or from the Start Menu:

![Launch VLab4Mic](https://github.com/CellMigrationLab/LabConstrictor/blob/doc_source/Windows_Launch.gif)
...
<a href="https://github.com/HenriquesLab/LabConstrictor-VLab4Mic/releases/download/0.1.3/VLab4Mic-0.1.3-Linux-x86_64.sh">
...
```bash
bash VLab4Mic-0.1.3-Linux-x86_64.sh
```
...
After installation, you can launch VLab4Mic from your applications menu and start using it following the instructions on the [Usage of Notebooks After Installation](./notebook_usage.md) guide.
...
<a href="https://github.com/HenriquesLab/LabConstrictor-VLab4Mic/releases/download/0.1.3/VLab4Mic-0.1.3-MacOSX-arm64.pkg">
...
<a href="https://github.com/HenriquesLab/LabConstrictor-VLab4Mic/releases/download/0.1.3/VLab4Mic-0.1.3-MacOSX-x86_64.pkg">
...
1. Double-click the downloaded file to start the installation process. It might give some errors, as shown bellow, go to `Settings > Privacy & Security > Security` and there the VLab4Mic package should appear. Click on `Open Anyway`.
...
After installation, you can launch VLab4Mic from your Applications folder and start using it following the instructions on the [Usage of Notebooks After Installation](./notebook_usage.md) guide.
...
<a href="https://github.com/HenriquesLab/LabConstrictor-VLab4Mic/releases/download/0.1.3/VLab4Mic-0.1.3-MacOSX-arm64.sh">
    <img src="https://img.shields.io/badge/Download%20for%20Mac%20(ARM64)-Latest-lightgrey?logo=apple&style=for-the-badge" alt="Download for Mac ARM64" width="250">
</a>

or 
    
<a href="https://github.com/HenriquesLab/LabConstrictor-VLab4Mic/releases/download/0.1.3/VLab4Mic-0.1.3-MacOSX-x86_64.sh">
    <img src="https://img.shields.io/badge/Download%20for%20Mac%20(Intel)-Latest-lightgrey?logo=apple&style=for-the-badge" alt="Download for Mac Intel" width="250">
</a>
...
2. Copy and paste the following command:
    ```bash
    bash VLab4Mic-0.1.3-MacOSX-ARCHITECTURE.sh
    ```
3. Click Enter to run the command.
...
![Uninstall VLab4Mic](https://github.com/CellMigrationLab/LabConstrictor/blob/doc_source/Windows_Uninstall.png)

or by directly going to `Settings` > `Apps` > `Installed apps`.

## 2. Uninstall VLab4Mic

Once there, search for `VLab4Mic` and click the three dots on the right and select `Uninstall`.
...
2.- Find VLab4Mic and delete it.

## 2. Uninstall VLab4Mic folder

1.- On the installation process, you chose a folder where you would install VLab4Mic. Find it.
2.- Delete that complete folder.

## 3. Check that the uninstallation has been correctly done

1.- Go to your `Trash` folder.
2.- Check that both VLab4Mic App and folder are there.
